...
while($items_array["role"][$item1_roll] == "AP"){
	$item1_roll = rand(0, 50);
}
$items_array["chosen"][$item1_roll] = true;

$item2_roll = rand(0, 50);
while($items_array["role"][$item2_roll] == "AP" or ($items_array["chosen"][$item2_roll] == true and $items_array["stackable"][$item2_roll] == false)){
	$item2_roll = rand(0, 50);
}
$items_array["chosen"][$item2_roll] = true;

$item3_roll = rand(0, 50);
while($items_array["role"][$item3_roll] == "AP" or ($items_array["chosen"][$item3_roll] == true and $items_array["stackable"][$item3_roll] == false)){
	$item3_roll = rand(0, 50);
}
$items_array["chosen"][$item3_roll] = true;

$item4_roll = rand(0, 50);
while($items_array["role"][$item4_roll] == "AP" or ($items_array["chosen"][$item4_roll] == true and $items_array["stackable"][$item4_roll] == false)){
	$item4_roll = rand(0, 50);
}
$items_array["chosen"][$item4_roll] = true;

$item5_roll = rand(0, 50);
while($items_array["role"][$item5_roll] == "AP" or ($items_array["chosen"][$item5_roll] == true and $items_array["stackable"][$item5_roll] == false)){
	$item5_roll = rand(0, 50);
}
