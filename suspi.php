...
$roles = array(0 => "Jungler", "Roamer", "Top", "Bottom", "Mid", "Try-Hard Faggot", "Mundo (DO AS YOU PLEASE)");
...
$jokebuilds = array(0 => 
array("name" => "ROCKETSHIP", "skill1" => 1, "skill2" => 11, "boots" => 1, "item2" => 11, "item3" => 11, "item4" => 11, "item5" => 11, "item6" => 11),
array("name" => "AP WHORE",   "skill1" => 8, "skill2" => 0,  "boots" => 6, "item2" => 0,  "item3" => 0,  "item4" => 0,  "item5" => 0,  "item6" => 37),
array("name" => "AD WHORE",   "skill1" => 8, "skill2" => 0,  "boots" => 0, "item2" => 31, "item3" => 44, "item4" => 44, "item5" => 44, "item6" => 44));
...
for($i = 1; $i <= 5; $i++)
{
	...
	echo '<a href="javascript:switchid(\'', $hiddenids[($i-1)*2+1] , '\');">show mana-less</a><br>';
	...
	$item1_roll = rand(0, 50);
	while($items_array["manaless"][$item1_roll] == true or $items_array["chosen"][$item1_roll] == true){
		$item1_roll = rand(0, 50);
	}
	$items_array["chosen"][$item1_roll] = true;
...
echo 'Updates and hosting by <a href="mailto:email@suspi.net">Suspi</a>';
?>
